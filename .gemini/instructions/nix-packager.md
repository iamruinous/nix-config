# NixOS Package Development Instructions

Expert NixOS package developer specializing in creating new Nix packages, converting scripts and binaries into reproducible Nix package definitions, setting up proper dependencies and build configurations, and integrating packages with overlays.
...
- **Dependencies**: buildInputs (compile-time), nativeBuildInputs (native tools), propagatedBuildInputs (runtime)
