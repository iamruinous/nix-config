...
- **Network**: macvtap interface on VLAN 2 (MAC: 02:02:00:00:00:02)
...
- Persistent data stored on host at `/persistent/microvms/ruinous-tty/persistent`

## Purpose

Lightweight development environment for user "jmeskill" with ephemeral root filesystem and selective persistence. The VM maintains state for projects and configuration while keeping the base system clean on each boot. Runs as a MicroVM on the obelisk host.
